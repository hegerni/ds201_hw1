...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: My name is __Nicholas Heger__. I am originally from Des Moines, IA. I am a senior attending Iowa State University. My major is _Computer Engineering_.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: A machine learning engineer is a job that I think is related to data science. A machine learning engineer is similar to a data scientist in that both jobs analyze large amounts of data and identify trends, however a machine learning engineer uses this information to create machine learning algorithms to create predictive models while a data scientist would prepare a human-readable report.  [Read more about machine learning engineers here](https://www.roberthalf.com/blog/the-future-of-work/how-to-become-a-machine-learning-engineer). ![](https://www.aiiottalk.com/wp-content/uploads/2020/01/Machine-Learning-Engineer-Salary.jpeg)
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I think the data topic I will be most interested in is data exploration. I really like diving into data and modeling it. As far as any datasets in specific, I don't have anything in particular in mind yet that I think would be interesting. I'm just looking to explore and learn.
